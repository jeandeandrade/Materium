...
export function Header() {
  return (
    <div className="max-w-[1740px] mx-auto py-5 flex-col gap-5">
      <div className="opacity-90 w-auto h-20 flex justify-between items-center m-6 px-4 rounded-full">
        <ul>
        ...
        <ul className="flex justify-center items-center gap-9">
          ...
          <Link href="/cadastro">
            <button className="border-2 border-zinc-500 bg-[#A3CAE9] text-zinc-700 opacity-85 font-semibold px-6 py-4 rounded-full hover:bg-blue-200 cursor-pointer">
              Cadastrar-se
            </button>
          </Link>
        </ul>
